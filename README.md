...
Geex seeks to combine the programmer productivity, simplicity and robustness of Clojure with high performance. It achieves this through generative programming and by remaining interoperable and symbiotic with regular Clojure code. This will facilitate efficient implentations for computationally intensive problems while taking advantage of the portability, ecosystem and interop of platforms such as the JVM. With Geex, we can use a wide range of high-level constructs such as functions and immutable data and still enjoy good performance.
